            ...
            <div>
              <ul className="careful-bottom">
                <li className="Serial-number">
                  <span className="Serial-number-span">{tags.number}</span>
                </li>
                <li className="Serial-img">
                  <img className="context-img" src={tags.face_pic_url}></img>
                  {/* {val.photograph} */}
                </li>
                ...
                <li className="Serial-time">
                  <span className="Serial-time-sapn">{tags.capture_time}</span>
                </li>
                <li className="Serial-video">
                  <video className="context-video" src={tags.bkg_pic_url}></video>
                  {/* {val.Controls} */}
                </li>
              </ul>
            </div>
