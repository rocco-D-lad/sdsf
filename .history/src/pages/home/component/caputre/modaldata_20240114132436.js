...
const ModalData = (prop) => {
  ...
  const Zhaopian = () => {
    Renlianzp().then((res) => {
      setPhotograph(res.data.data.slice(0,27))
  ...
  return (
    ...
    >
      <div className="Capture-photograph">
        ...
        <div>
          <Pagination defaultCurrent={1} total={photograph.length} defaultPageSize={15} className="paging" onChange={(e)=>{console.log('eee',e)}} />
        </div>
      </div>
    </Modal>
  )
