    ...
    <div id="rocco-li">
      <div id="rocco">
        <div className="information-header">
          ...
          <div className="header-img" onClick={props.onbacks}></div>
        </div>
        <div className="information-content">
          ...
          <div className="content-text">
            {Object.keys(analarm).map((val, index) => (
              <ul className="context-text-ul">
                <li>
                  名称: &nbsp;&nbsp;&nbsp;&nbsp;<span>{val.alarmAddr}</span>
                </li>
                <li>
                  类型:&nbsp;&nbsp;&nbsp;&nbsp;<span>{val.typeName}</span>
                </li>
                <li>
                  等级:&nbsp;&nbsp;&nbsp;&nbsp;<span>{val.alarm_lv}</span>
                </li>
                <li>
                  地点:&nbsp;&nbsp;&nbsp;&nbsp;<span>校区-1区</span>
                </li>
                <li>
                  时间:&nbsp;&nbsp;&nbsp;&nbsp;<span>{val.alarmTime}</span>
                </li>
              </ul>
            ))}
          </div>
