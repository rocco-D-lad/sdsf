    ...
    <>
      ...
      <div id="background-max">
        <div id="background-img">
            ...
            <div className="round-right">
                    ...
                    <div className="down-input">
                      ...
                      <div className="Capture-photograph">
                        <div className="Capture-library">
                          <div
                            className="Capture-library-left"
              ...
              <div className="there">
                <div className="round-left-top">
                  ...
                  <select className="round-left-select" name="fruits" onChange={(e)=>{console.log(e.target.value,'e123')}}>
                    {/* <select name="fruits"> */}
                    <option value="apple" className="round-left-option">
                      近七天
                    </option>
                    <option value="banana" className="round-left-option">
                      当天
                    </option>
          ...
          {trajectory && <Searchs trajectory={trajectory} onback={onSearch}></Searchs>}
        </div>
      </div>
    </>
  )
