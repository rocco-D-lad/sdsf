    ...
    <>
      ...
      <div id="background-max">
        <div id="background-img">
                ...
                <div className="one">
                  ...
                  <div className="round-left-header">
                    <p className="hunt-down" onClick={onCapture}>
                      <img src={`${imgSrc?imgSrc:'默认图片url'}`} className='hunt-down-img' onClick={onCapture}/>
                    </p>
          ...
          {caputre && <ModalData setImgSrc={setImgSrc} caputre={caputre} onback={onBack}></ModalData>}
          {trajectory && (
